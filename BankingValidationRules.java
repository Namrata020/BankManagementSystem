...
public class BankingValidationRules {
	...
	// In case of no transactions (withdraw , deposit, funds transfer) ,
	...
	public static void disableAccounts(Map<Integer, BankAccount> acctMap) {
		...
		// transform: Map ---> Collection<V> : using values()
	...
	public static BankAccount validateAllInputs(int acctNo, String customerName, String acctType, 
			double balance,String creationDate, Map<Integer, BankAccount> map)
	...
	public static void disableInaccounts(Map<Integer, BankAccount> acctMap) {
		// since it's searching based upon : value based criteria ,
		...
		//System.out.println("A/C closed by admin!");
